...
conditions = {'time-vs-dist_time-vs-dots', 'time-vs-dist_dist-vs-dots', 'time-vs-dots_dist-vs-dots'};
fwe = 0.001;
Nperm = 1000;
...
for condition = conditions
    ...
    files=[];
    for split = splits
        input_filename = sprintf('diff_image_%s_split-%02d', condition{1}, split);
