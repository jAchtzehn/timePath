...
for condition_pair in cbar:
	...
	[corr_img_thresh, th] = threshold_stats_img(corr_img, cluster_threshold=30)

	corr_img_thresh.to_filename(opj(rsa_dir, 'corrImg_rel-{}_irrel-{}.nii.gz'.format(condition_pair[0], condition_pair[1])))
